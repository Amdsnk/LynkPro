    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                // Decision Intelligence Interface colors
                ...
                risk: {
                    ...
                    'critical-lighter': 'hsl(var(--risk-critical-lighter))',
                    ...
                    'minimal-light': 'hsl(var(--risk-minimal-light))'
                }
            },
            borderRadius: {
                lg: 'var(--radius)',
            ...
            keyframes: {
                ...
                // Decision Intelligence Interface animations
                'risk-pulse': {
                    '0%, 100%': {
                        opacity: '1',
                        transform: 'scale(1)'
            ...
            fontSize: {
                ...
                tiny: ['0.75rem', { lineHeight: '1.3', fontWeight: '400' }]
            },
            backdropBlur: {
                xs: '2px'
            }
